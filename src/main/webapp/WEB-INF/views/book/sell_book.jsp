...
<body>
	...
	<div class="sell-form">
		...
		<form action="${pageContext.request.contextPath}/sell_book"
			...
			<div class="sell-row">
				...
				<div>
					<label>Tình trạng</label> <select name="condition" required>
			...
			<textarea name="description"
				placeholder="Mô tả chi tiết về cuốn sách..."></textarea>
