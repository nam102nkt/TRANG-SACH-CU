...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/book_detail.css?v=3">
</head>
...
<body data-context="${pageContext.request.contextPath}">
    ...
    <!-- IMPORT JS -->
    <script src="${pageContext.request.contextPath}/assets/js/book_detail.js?v=3"></script>
