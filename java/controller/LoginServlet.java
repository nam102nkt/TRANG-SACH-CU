...
public class LoginServlet extends HttpServlet {
	 ...
	 *      response) Khi người dùng truy cập /login, chỉ hiển thị form
	 */
	 ...
	 *      response) Khi người dùng nhấn nút "Đăng nhập"
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 2. Kiểm tra
		// if (user != null && user.getPassword().equals(plainPassword)) { // CÁCH CŨ,
		// KHÔNG BẢO MẬT
